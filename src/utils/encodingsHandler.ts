...
import type {RtpCapabilities, RtpCodecCapability, RtpEncodingParameters} from 'mediasoup-client/lib/RtpParameters';
import { ProducerCodec, Resolution, SimulcastProfile } from "../services/room/types";
...
export const getCodec = (
  rtpCapabilities: RtpCapabilities,
  codec:ProducerCodec = 'video/h264'
): RtpCodecCapability => {

  return rtpCapabilities.codecs.find((c: any) => c.mimeType.toLowerCase() === codec);
};
