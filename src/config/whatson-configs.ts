...
/*  images: {
    ...
    ChatInstanceBackground: require("../../assets/images/whatson/chat-instance-background.png"),
    SetPassword: require("../../assets/images/set-pass.png"),
    SettingsLogo: require("../../assets/images/whatson/moi-logo.png")
  },
  animations: {
  ...
  palette: {
    ...
    dark: {
      ...
      disabledColor: "#EDEDED",
      bubbleMeContainerColor: "#b5986b",
      bubbleHimContainerColor: "#3A3A3A",
      bubbleMeTextColor: "#ffffff",
